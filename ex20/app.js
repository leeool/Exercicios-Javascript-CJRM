...
const displayCounter = document.querySelector(".counter-container")

let timer = null

const incrementCounter = () => {
  const incrementedCounter = Number(displayCounter.textContent) + 1
  displayCounter.textContent = incrementedCounter
}
...
initCounterButton.addEventListener("click", () => {
