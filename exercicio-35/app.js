...
localStorage.setItem("myKey", stringifyedItem)

localStorage.setItem("myKey2", {})

const parsedItemJS = (keyName) => {
  const item = localStorage.getItem(keyName)
  return JSON.parse(item)
}

console.log(parsedItemJS("myKey"))
...
const combineOperations = (value, arrayFunctions) => {
