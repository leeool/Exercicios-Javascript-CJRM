...
const oddNumbers = randomNumbers.filter(isOdd)
...
const numberBelow501 = crazyNumbers.reduce((accumulator, number) => {
  return number < 501 ? ++accumulator : accumulator
}, 0)

console.log(numberBelow501)
...
// const cartNames = cart.forEach(item => {
//   return console.log(names += `- ${item.name}`)
// })
