...
const onlyThreeLettersAnimal = animals
  .map(animal => animal)
  .filter(({ length }) => length <= 3)

console.log(onlyThreeLettersAnimal)
...
const lettersCounter = animals.map(({ length }) => length)
...
const SumPopCoutriesExceptChina = data
...
console.log(SumPopCoutriesExceptChina)
