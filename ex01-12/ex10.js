...
const addColor = (object, newColor) => {
   object["color"] += ` e ${newColor}`
};
...
const isObject = object => console.log(typeof object === 'object')
...
const sumAges = (obj1, obj2) => {
  return console.log(`A soma das idades de ${obj1.name} e ${obj2.name} é ${obj1.age + obj2.age}.`)
}
...
const cars = ["HondaHR-V", "Jeep Renegade", "Ford EcoSport", "Hyundai iX35"]
...
const funcTypes = type => {
  const objectTypes = {
    null: "Seta, explicitamente, uma variável sem valor",
    undefined: "Representa um valor não-setado",
    object: "Arrays, Datas, Objetos literais, funções, etc."
  }
  return console.log(objectTypes[type])
}
