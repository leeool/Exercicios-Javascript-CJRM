...
/*
  ...
  - Exiba no console um boolean indicando se o array de séries que você criou  
    possui 3 itens.
*/
console.log(Boolean(my3FavoriteTVShows.length == 3));
...
const is39 = Boolean(typeSentence.length > 39);
const stringBoolean = String(is39);

console.log(
  `A string que a "typeSentence" armazena tem mais de 39 caracteres? ${
    stringBoolean[0].toUpperCase() + stringBoolean.slice(1)
  }`
);
...
const isNotAString = Boolean(typeof randomTVShow !== "string");
...
console.log(Boolean(evenNumbers.indexOf(11) >= 0));
